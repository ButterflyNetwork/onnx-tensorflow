...
import onnx_tf_prenatal.backend
import onnx_tf_prenatal.backend_rep
...
def gen_api(docs_dir):
  gen_doc_for = {
      'onnx_tf.backend': [
          onnx_tf_prenatal.backend.prepare,
      ],
      'onnx_tf.backend_rep.TensorflowRep': [
          onnx_tf_prenatal.backend_rep.TensorflowRep.export_graph,
      ]
  }
